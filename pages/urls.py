...
urlpatterns = [
    ...
    path("storefront", views.storefront_view, name="storefront_view"),
    path("storefront/leave-feedback", views.leave_feedback_view, name="leave_feedback_view"),
    path("storefront/delete-feedback", views.delete_feedback_view, name="delete_feedback_view"),
    ...
    path("product/copy-and-add-product/id/<uuid:uuid>", views.copy_and_add_product_view, name="copy_and_add_product_view"),
    ...
    path("profile/settings/upload-banner-picture", views.upload_banner_picture_view, name="upload_banner_picture_view"),
    path("profile/settings/change-state-territory", views.change_state_territory_view, name="change_state_territory_view"),
